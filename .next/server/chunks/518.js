"use strict";exports.id=518,exports.ids=[518],exports.modules={6518:(e,t,a)=>{a.r(t),a.d(t,{default:()=>i});let o=`
...
- get-company-info
- create-company
`,i={id:"login-flow-info",metadata:{title:"Login & Company Flow and Instructions",description:"Explains the flow for login and company management",argsSchema:[]},handler:()=>({messages:[{role:"assistant",content:{type:"text",text:o}}]})}}};